...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_with_macro(
    ...
    KC_F1,               KC_VOLU,  KC_GRV,  KC_1,         KC_2,         KC_3,         KC_4,        KC_5,    KC_6,    KC_7,        KC_8,         KC_9,         KC_0,            KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC, KC_HOME,
    KC_MEDIA_PLAY_PAUSE, KC_VOLD,  KC_TAB,  KC_Q,         KC_W,         KC_E,         KC_R,        KC_T,    KC_Y,    KC_U,        KC_I,         KC_O,         KC_P,            KC_LBRC, KC_RBRC, KC_BSLS, KC_END,
    KC_F5,               KC_F6,    KC_LCTL, LCTL_T(KC_A), LGUI_T(KC_S), LSFT_T(KC_D), LT(1, KC_F), KC_G,    KC_H,    LT(1, KC_J), RSFT_T(KC_K), RGUI_T(KC_L), RCTL_T(KC_SCLN), KC_QUOT, KC_ENT,  KC_PGUP,
  ...
  [1] = LAYOUT_80_with_macro(
    ...
    RGB_VAI,             RGB_VAD, _______, _______,       KC_LPRN,      KC_RPRN,      _______,     _______, KC_LEFT, KC_DOWN,     KC_UP  ,      KC_RIGHT,     _______,  _______,          _______, _______,
