...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_80_with_macro(
    ...
    KC_F5,     KC_VOLD, /*|*/ KC_LCTL, EL_A,    EL_S,    EL_D,    EL_F,     KC_G,             /*|*/ KC_H,    EL_J,    EL_K,     EL_L,     EL_SCLN, KC_ENT,      KC_QUOT,      KC_PGUP,
  ...
  [LF] = LAYOUT_80_with_macro(
   EE_CLR,    _______, /*|*/ _______, _______, _______,   _______, _______,  _______, _______, /*|*/ _______, _______, _______,  _______,  _______, TG(GAME), TG(GAME),
    ...
    RGB_SAI,   RGB_SAD, /*|*/ KC_ESC,  EL_LF_Q, KC_COLON, _______, _______,  _______,          /*|*/ KC_HOME, KC_PIPE, KC_QUOT,  KC_DQUO,  _______, _______, _______, _______, QK_REBOOT,
    ...
    RGB_TOG,   _______, /*|*/ _______, _______, _______,  _______, _______,  _______,          /*|*/ EL_LF_N, KC_PGDN, _______,  _______,  _______,     _______,      DT_UP,   _______,
  ...
  [LJ] = LAYOUT_80_with_macro(
    ...
    RGB_HUI,   RGB_HUD, /*|*/ QK_GESC, KC_F1,   KC_F2,    KC_F3,   KC_F4,    KC_F5,   KC_F6,   /*|*/ KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,  KC_F12,  _______, _______, QK_BOOT,
    RGB_SAI,   RGB_SAD, /*|*/ KC_ESC,  EL_LJ_Q, KC_COLON, KC_LBRC, KC_RBRC,  EL_LJ_T,          /*|*/ _______, _______, _______,  _______,  _______, _______, _______, _______, QK_REBOOT,
    RGB_VAI,   RGB_VAD, /*|*/ _______, _______, _______,  KC_LPRN, KC_RPRN,  EL_LJ_G,          /*|*/ _______, _______, _______,  _______, _______, EL_LJ_QUOT,  _______,      _______,
    RGB_TOG,   RGB_MOD, /*|*/ _______, _______, _______,  KC_LCBR, KC_RCBR,  _______,          /*|*/ EL_LJ_N, _______, _______,  _______,  _______,     _______,      _______, _______,
