...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LBASE] = LAYOUT(
    ...
    OSM(MOD_LSFT), KC_Z,         KC_X,         LALT_T(KC_C), LT(LV, KC_V), KC_B,          KC_HOME,    /* || */  KC_END,  KC_N,    LT(LM, KC_M), LALT_T(KC_COMM), KC_DOT,       KC_SLSH,         OSM(MOD_RSFT),
  ...
  [LF] = LAYOUT(
    ...
    _______,       KC_ESC,       KC_COLN,      KC_GRV,       _______,      _______,                   /* || */           KC_TILD, LSFT(KC_TAB), KC_TAB,          KC_EQL,       KC_UNDS,         _______,
    _______,       _______,      _______,      _______,      _______,      TO(LGAME),                 /* || */           KC_LEFT, KC_DOWN,      KC_UP,           KC_RIGHT,     _______,         _______,
  ...
  [LJ] = LAYOUT(
    ...
    _______,       KC_ESC,       KC_COLN,      KC_LPRN,      KC_RPRN,      _______,                   /* || */           _______, _______,      _______,         _______,      _______,         _______,
    _______,       KC_UNDS,      KC_MINS,      KC_LBRC,      KC_RBRC,      KC_DLR,                    /* || */           _______, _______,      _______,         _______,      _______,         _______,
    _______,       KC_PIPE,      KC_LABK,      KC_LCBR,      KC_RBRC,      KC_RABK,       KC_F12,     /* || */  _______, _______, _______,      _______,         _______,      _______,         _______,
                                                             _______,      _______,       _______,    /* || */  _______, _______, _______
  ),
  [LV] = LAYOUT(
    _______,       _______,      _______,      _______,      _______,      _______,                   /* || */           _______, _______,      _______,         _______,      _______,         _______,
    _______,       _______,      KC_VOLU,      _______,      _______,      _______,                   /* || */           KC_PLUS, KC_7,         KC_8,            KC_9,         KC_ASTR,         _______,
  ...
  [LGAME] = LAYOUT(
    ...
    KC_LSFT,       KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,          TO(LBASE),  /* || */  KC_END,  KC_N,    KC_M,         KC_COMM,         KC_DOT,       KC_SLSH,         KC_RSFT,
                                                             KC_LCTL,      OSM(MOD_LGUI), KC_SPC,     /* || */  KC_ENT,  KC_BSPC, KC_RALT
  ),
};