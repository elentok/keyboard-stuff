...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LBASE] = LAYOUT(
    ...
    OSM(MOD_LSFT),    KC_Z,         KC_X,               LALT_T(KC_C),     KC_V,             KC_B,             KC_SPC,   /* || */  KC_ENT,  KC_N,          KC_M,      RALT_T(KC_COMM),    KC_DOT,       KC_SLSH,         OSM(MOD_RSFT),
...
const uint16_t PROGMEM combo10[] = {KC_M, RALT_T(KC_COMM), KC_DOT, COMBO_END};
