...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LLAYER1] = LAYOUT(
    ...
    _______,          KC_GRV,           KC_LPRN,              KC_RPRN,          KC_EQL,           KC_TILD,                       /* || */           TO(LSEL),            KC_UNDS,   KC_LBRC,             KC_RBRC,              KC_RPRN,   _______,
  ...
  [LSEL] = LAYOUT(
    ...
    _______,          TO(LBASE),        LSFT(LALT(KC_RIGHT)), _______,          _______,          _______,                       /* || */           EL_COPY,             _______,   _______,             _______,              EL_PASTE,  _______,
    _______,          _______,          KC_LSFT,              KC_LALT,          KC_LGUI,          _______,                       /* || */           KC_LEFT,             KC_DOWN,   KC_UP,               KC_RIGHT,             _______,   _______,
    _______,          _______,          EL_CUT,               EL_COPY,          EL_PASTE,         LSFT(LALT(KC_LEFT)), _______,  /* || */  _______, LSFT(LALT(KC_LEFT)), _______,   LSFT(LALT(KC_LEFT)), LSFT(LALT(KC_RIGHT)), TO(LBASE), _______,
