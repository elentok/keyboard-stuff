...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LF] = LAYOUT(
    ...
    _______,          KC_LALT,    KC_LSFT,            _______,          _______,          _______,                    /* || */           KC_EQL,    KC_MINS,   KC_LBRC,            KC_RBRC,      KC_PGUP, _______,
  ...
  [LJK] = LAYOUT(
    ...
    KC_EQL,           KC_UNDS,    KC_MINS,            KC_ESC,           KC_COLN,          KC_DLR,                     /* || */           _______,   _______,   _______,            KC_RGUI,      KC_RCTL, _______,
    LSFT(KC_TAB),     KC_EQL,     KC_LCBR,            KC_RCBR,          _______,          _______,          _______,  /* || */  _______, _______,   _______,   _______,            KC_RALT,      KC_RCTL, _______,
...
const uint16_t PROGMEM combo3[] = {KC_LGUI, KC_A, COMBO_END};
const uint16_t PROGMEM combo4[] = {KC_LGUI, KC_A, KC_S, COMBO_END};
...
const uint16_t PROGMEM combo8[] = {KC_SCLN, KC_QUOT, COMBO_END};
const uint16_t PROGMEM combo9[] = {KC_C, KC_V, COMBO_END};
const uint16_t PROGMEM combo10[] = {KC_X, KC_C, KC_V, COMBO_END};
const uint16_t PROGMEM combo11[] = {KC_V, KC_B, COMBO_END};
const uint16_t PROGMEM combo12[] = {KC_D, KC_F, COMBO_END};
const uint16_t PROGMEM combo13[] = {KC_J, KC_K, COMBO_END};
const uint16_t PROGMEM combo14[] = {KC_J, KC_L, COMBO_END};
const uint16_t PROGMEM combo15[] = {KC_J, KC_O, COMBO_END};
const uint16_t PROGMEM combo16[] = {KC_W, KC_F, COMBO_END};
const uint16_t PROGMEM combo17[] = {KC_U, KC_I, KC_O, COMBO_END};
const uint16_t PROGMEM combo18[] = {KC_M, KC_COMM, KC_DOT, COMBO_END};

combo_t key_combos[19] = {
  COMBO(combo0, KC_LALT),
  COMBO(combo1, KC_LSFT),
  COMBO(combo2, KC_LGUI),
  COMBO(combo3, KC_LCTL),
  COMBO(combo4, LALT(KC_LCTL)),
  COMBO(combo5, KC_RALT),
  COMBO(combo6, KC_RSFT),
  COMBO(combo7, KC_RGUI),
  COMBO(combo8, KC_RCTL),
  COMBO(combo9, MO(LNUM)),
  COMBO(combo10, MO(LSNUM)),
  COMBO(combo11, MO(LFKEYS)),
  COMBO(combo12, MO(LF)),
  COMBO(combo13, MO(LJK)),
  COMBO(combo14, KC_ESC),
  COMBO(combo15, KC_EQL),
  COMBO(combo16, KC_GRV),
  COMBO(combo17, LCTL(LSFT(LGUI(KC_I)))),
  COMBO(combo18, LGUI(KC_1)),
};