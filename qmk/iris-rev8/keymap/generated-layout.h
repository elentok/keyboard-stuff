...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LBASE] = LAYOUT(
    ...
    OSM(MOD_LGUI), LCTL_T(KC_A), LSFT_T(KC_S), LGUI_T(KC_D), LT(LF, KC_F),  KC_G,                    /* || */           KC_H,      LT(LJ, KC_J), RGUI_T(KC_K),       RSFT_T(KC_L), RCTL_T(KC_SCLN), OSM(MOD_RGUI),
    OSM(MOD_LSFT), KC_Z,         KC_X,         LALT_T(KC_C), LT(LV, KC_V),  KC_B,          KC_SPC,   /* || */  KC_ENT,  KC_N,      LT(LM, KC_M), LALT_T(KC_COMM),    KC_DOT,       KC_SLSH,         OSM(MOD_RSFT),
                                                             OSM(MOD_LCTL), OSM(MOD_LGUI), KC_SPC,   /* || */  KC_ENT,  KC_BSPC,   KC_RALT
  ),
  [LF] = LAYOUT(
    KC_ESC,        KC_EXLM,      KC_AT,        KC_HASH,      KC_DLR,        QK_BOOT,                 /* || */           KC_CIRC,   KC_AMPR,      KC_ASTR,            KC_MINS,      KC_EQL,          _______,
    _______,       KC_ESC,       _______,      _______,      _______,       _______,                 /* || */           KC_UNDS,   KC_PGDN,      LSFT(KC_TAB),       KC_TAB,       KC_PGUP,         KC_BSLS,
  ...
  [LJ] = LAYOUT(
    KC_ESC,        KC_EXLM,      KC_AT,        KC_HASH,      KC_DLR,        KC_5,                    /* || */           _______,   _______,      _______,            _______,      _______,         _______,
