...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LSEL] = LAYOUT(
    ...
    _______,          TO(LBASE),        _______,            _______,          _______,          _______,                    /* || */           LGUI(KC_C),  TO(LBASE), _______,       _______,        LGUI(KC_V), _______,
    _______,          KC_LCTL,          KC_LSFT,            KC_LALT,          KC_LGUI,          _______,                    /* || */           KC_LEFT,     KC_DOWN,   KC_UP,         KC_RIGHT,       _______,    _______,
    _______,          _______,          LGUI(KC_X),         LGUI(KC_C),       LGUI(KC_V),       _______,          _______,  /* || */  _______, _______,     _______,   LALT(KC_LEFT), LALT(KC_RIGHT), TO(LBASE),  _______,
