...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LF] = LAYOUT(
    ...
    _______,       KC_ESC,       _______,      _______,      _______,      _______,                   /* || */           KC_TILD, KC_PGDN,      LSFT(KC_TAB),    KC_TAB,       KC_PGUP,         _______,
  ...
  [LJ] = LAYOUT(
    _______,       KC_EXLM,      KC_AT,        KC_HASH,      KC_DLR,       KC_5,                      /* || */           _______, _______,      _______,         _______,      _______,         _______,
    KC_ASTR,       KC_GRV,       KC_COLN,      KC_LPRN,      KC_RPRN,      KC_TILD,                   /* || */           _______, _______,      _______,         _______,      _______,         _______,
    KC_EQL,        KC_UNDS,      KC_MINS,      KC_LBRC,      KC_RBRC,      KC_DLR,                    /* || */           _______, _______,      _______,         _______,      _______,         _______,
