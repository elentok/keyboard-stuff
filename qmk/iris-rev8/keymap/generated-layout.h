...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LBASE] = LAYOUT(
    SUPER_ESC,     KC_1,         KC_2,             KC_3,             KC_4,             KC_5,                       /* || */           KC_6,      KC_7,         KC_8,               KC_9,         KC_0,            KC_BSPC,
  ...
  [LF] = LAYOUT(
    SUPER_ESC,     _______,      LGUI(LSFT(KC_4)), LGUI(LSFT(KC_5)), KC_DLR,           QK_BOOT,                    /* || */           KC_CIRC,   KC_AMPR,      KC_ASTR,            KC_MINS,      KC_EQL,          _______,
    KC_TAB,        SUPER_ESC,    _______,          _______,          _______,          _______,                    /* || */           KC_UNDS,   KC_PGDN,      LSFT(KC_TAB),       KC_TAB,       KC_PGUP,         KC_BSLS,
  ...
  [LJ] = LAYOUT(
    SUPER_ESC,     KC_EXLM,      KC_AT,            KC_HASH,          LGUI(LSFT(KC_4)), LGUI(LSFT(KC_5)),           /* || */           _______,   _______,      _______,            _______,      _______,         _______,
