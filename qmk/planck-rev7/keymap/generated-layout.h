...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LBASE] = LAYOUT(
    ...
    KC_ESC,           KC_Z,         KC_X,         LALT_T(KC_C), LT(LV, KC_V),  KC_B,      KC_N,      LT(LM, KC_M), LALT_T(KC_COMM),    KC_DOT,       KC_SLSH,         KC_BSLS,
    OSM(MOD_LSFT),    _______,      _______,      _______,      KC_LCTL,       KC_SPC,    KC_SPC,    KC_ENT,       KC_BSPC,            KC_RALT,      KC_BSLS,         OSM(MOD_RSFT)
  ),
  [LF] = LAYOUT(
    QK_BOOT,          KC_ESC,       _______,      _______,      _______,       _______,   KC_UNDS,   KC_PGDN,      LSFT(KC_TAB),       KC_TAB,       KC_PGUP,         _______,
    _______,          _______,      _______,      _______,      _______,       TO(LGAME), KC_LEFT,   KC_DOWN,      KC_UP,              KC_RIGHT,     KC_DLR,          _______,
    _______,          _______,      _______,      _______,      _______,       _______,   KC_BSPC,   KC_ENT,       KC_HOME,            KC_END,       KC_SLSH,         _______,
  ...
  [LJ] = LAYOUT(
    ...
    _______,          KC_PIPE,      KC_LABK,      KC_LCBR,      KC_RCBR,       KC_RABK,   _______,   _______,      _______,            _______,      _______,         _______,
    LCTL(LGUI(KC_Q)), _______,      _______,      _______,      _______,       _______,   _______,   _______,      _______,            _______,      _______,         _______
  ),
  [LV] = LAYOUT(
    _______,          _______,      KC_VOLU,      _______,      _______,       _______,   KC_PLUS,   KC_7,         KC_8,               KC_9,         KC_EQL,          _______,
    _______,          _______,      _______,      KC_MPLY,      _______,       _______,   KC_MINS,   KC_4,         KC_5,               KC_6,         KC_0,            _______,
    _______,          _______,      KC_VOLD,      _______,      _______,       _______,   KC_0,      KC_1,         KC_2,               KC_3,         KC_DOT,          _______,
  ...
  [LM] = LAYOUT(
    ...
    _______,          _______,      _______,      _______,      _______,       _______,   _______,   _______,      _______,            KC_VOLD,      _______,         _______,
    _______,          _______,      _______,      _______,      _______,       _______,   _______,   _______,      _______,            _______,      _______,         _______
  ),
  [LGAME] = LAYOUT(
    ...
    KC_ESC,           _______,      _______,      KC_LCTL,      OSM(MOD_LGUI), KC_SPC,    KC_ENT,    KC_BSPC,      KC_RALT,            _______,      _______,         KC_BSPC
  ),
  [LONE] = LAYOUT(
