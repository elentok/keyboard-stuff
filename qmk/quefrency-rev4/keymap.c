...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_65_with_macro(
    ...
    KC_F9,                 MY_KC_LOCK, KC_LCTL, MO(L1), KC_LALT, KC_LGUI, EL_SPC,   _______, EL_SPC, MO(L1), KC_RCTL, _______, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [L1] = LAYOUT_65_with_macro(
    ...
    _______,               _______, _______, _______,    _______, _______, _______, KC_TAB,  KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT, _______, _______, _______, _______,
    _______,               _______, _______, _______,    _______, _______, _______, _______, KC_BSPC, _______, _______, _______,  _______, _______, _______, _______,
    _______,               _______, KC_TILD, _______,    _______, _______, _______,          _______, _______, _______, _______,  _______, _______, _______, _______
  ),

  [L2] = LAYOUT_65_with_macro(
    _______,               _______, KC_GRV,  KC_F1,      KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_BSPC, _______,
    _______,               _______, RGB_TOG, RGB_MOD,    KC_LBRC, KC_RBRC, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______,
    _______,               _______, _______, MY_KC_LOCK, KC_LPRN, KC_RPRN, _______, KC_TAB,  _______, _______, _______, _______,  _______, _______, _______, _______,
