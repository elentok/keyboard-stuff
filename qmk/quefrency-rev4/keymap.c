...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LF] = LAYOUT_65_with_macro(
    ...
    _______,               _______,  /*|*/ _______, _______, _______, _______, _______, EL_LF_G,          /*|*/ KC_LEFT, KC_DOWN, KC_UP  ,  KC_RIGHT, _______, EL_LF_QUOT,          _______, _______,
    _______,               _______,  /*|*/ _______, _______, _______, _______, _______, _______,          /*|*/ EL_LF_N, _______, _______,  _______,  _______, _______,             _______, _______,
    _______,               _______,  /*|*/ _______, _______, _______, _______, _______, _______,          /*|*/ _______, _______, _______,  _______,                       _______, _______, _______
  ),

  [LJ] = LAYOUT_65_with_macro(
    _______,               _______,  /*|*/ KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   /*|*/ KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,  KC_F12,     KC_DEL,  KC_BSPC, _______,
    _______,               _______,  /*|*/ RGB_TOG, RGB_MOD, KC_LBRC, KC_RBRC, _______, _______,          /*|*/ _______, _______, ELC_LOCK, _______,  _______, _______,    _______, _______, _______,
    _______,               _______,  /*|*/ _______, _______, KC_LPRN, KC_RPRN, _______, EL_LJ_G,          /*|*/ KC_LEFT, KC_DOWN, KC_UP  ,  KC_RIGHT, _______, EL_LF_QUOT,          _______, _______,
