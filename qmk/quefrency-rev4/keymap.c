...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F9,                 MY_KC_LOCK, KC_LCTL, MO(_FN1),KC_LALT, KC_LGUI, KC_SPC,        _______,        LT(_FN1, KC_SPC), MO(_FN1), KC_RCTL,        _______,       KC_LEFT,      KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT_65_with_macro(
    ...
    _______,               _______, _______, MY_KC_LOCK, KC_LPRN, KC_RPRN, _______, KC_TAB, KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT, _______, _______, _______, _______,
