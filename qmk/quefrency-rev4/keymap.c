...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LF] = LAYOUT_65_with_macro(
    ...
    RGB_TOG,               _______,  /*|*/ _______, EL_LF_Q, KC_COLN, KC_RBRC, _______, _______,          /*|*/ _______, KC_PGUP, _______,  _______,  _______, _______,    _______, _______, QK_REBOOT,
    ...
    _______,               _______,  /*|*/ _______, _______, _______, _______, _______, _______,          /*|*/ EL_LF_N, EL_LF_M,    _______,  _______,  _______, _______,             DT_UP  , _______,
    _______,               _______,  /*|*/ _______, _______, _______, _______, EL_LF_LSPC, _______,       /*|*/ EL_LF_RSPC, _______, _______,  _______,                       _______, DT_DOWN, DT_PRNT
  ),
  ...
  [LJ] = LAYOUT_65_with_macro(
    ...
    _______,               _______,  /*|*/ _______, _______, KC_LCBR, KC_RCBR, _______, _______,          /*|*/ EL_LJ_N, EL_LJ_M, _______,  _______,  _______, _______,             _______, _______,
