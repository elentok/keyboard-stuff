...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LF] = LAYOUT_65_with_macro(
    ...
    RGB_TOG,               _______,  /*|*/ _______, EL_LF_Q, KC_LBRC, KC_RBRC, _______, _______,          /*|*/ _______, _______, _______,  _______,  _______, _______,    _______, _______, QK_REBOOT,
  ...
  [LJ] = LAYOUT_65_with_macro(
    ...
    RGB_MOD,               _______,  /*|*/ _______, _______, KC_LPRN, KC_RPRN, _______, EL_LJ_G,          /*|*/ KC_LEFT, KC_DOWN, KC_UP  ,  KC_RIGHT, _______, EL_LF_QUOT,          _______, _______,
